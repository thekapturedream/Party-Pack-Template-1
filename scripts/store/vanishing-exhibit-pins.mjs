// Pinterest pins for The Vanishing Exhibit: 2:3 vertical, built from real pages
// of the kit. Pinterest is the second channel in docs/go-to-market.md and the
// one that compounds, so the pins show the actual evidence sheets rather than
...
await renderAll({ theme: 'museum', out: 'store/pins', css: CSS, images: PINS.map((p) => ({ ...p, w: W, h: H })), scale: 2, bare: true, jpegOnly: true, quality: 90 });
